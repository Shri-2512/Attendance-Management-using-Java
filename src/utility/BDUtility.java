...
public class BDUtility {
        public static void setImage( JFrame frame, String imagePath, int newWidth, int newheight)
        {
            try {
                ...
                resizeImage.createGraphics().drawImage(originalImage.getScaledInstance(newWidth, newheight, Image.SCALE_SMOOTH), 0, 0,null);
                ImageIcon backgroudImage=new ImageIcon(resizeImage);
                JLabel backgroundLabel=new JLabel(backgroudImage);
        ...
        public static BufferedImage scaleImage(BufferedImage originalImage, BufferedImage selectedImage)
        {
            ...
            int heigth=selectedImage.getHeight();
            BufferedImage scaledImage=new BufferedImage(width, heigth, originalImage.getType());
            scaledImage.createGraphics().drawImage(originalImage.getScaledInstance(width, heigth, Image.SCALE_SMOOTH), 0, 0, null);
            return scaledImage;
        }
}
