...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       ...
       if("shri1225@gmail.com".equalsIgnoreCase(email)&&"Shri1225".equalsIgnoreCase(password))
       {
           //this.dispose();
           BDUtility.openForm(Dashboard.class.getSimpleName(), new Dashboard());
       }
       else{
           JOptionPane.showMessageDialog(null,"Invalid credentails", "invalid",JOptionPane.ERROR_MESSAGE);
       }
